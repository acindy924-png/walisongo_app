...
import 'location_detail_page.dart'; // ← import halaman detail peta
...
class _LokusiPageState extends State<LokusiPage> {
  ...
  // ── DATA LOKASI (ditambah koordinat lat/lng & alamat) ──────────
      ...
      child: Row(
        children: [
          GestureDetector(
            ...
            child: const Icon(Icons.arrow_back, color: Color(0xFF1A1A1A), size: 22),
          ),
          ...
          Expanded(
            child: _isSearching
                ? TextField(
                    ...
                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: primaryGreen),
          ...
          GestureDetector(
            ...
            child: Icon(_isSearching ? Icons.close : Icons.search, color: primaryGreen, size: 24),
          ),
        ],
      ),
    );
      ...
      child: Center(
        child: Column(
          children: [
            ...
            Text(
              _isSearching ? 'Sunan tidak ditemukan.' : 'Belum ada lokasi di wilayah ini.',
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text(
            'Lokasi Ziarah',
            style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: primaryGreen, height: 1.2),
          ),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: lightGreenBg, borderRadius: BorderRadius.circular(6)),
                      child: Text(item['tag'],
                          style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: primaryGreen, letterSpacing: 0.8)),
                    ),
                    const SizedBox(width: 10),
                    Expanded(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildButton(
                        ...
                        onTap: () {
                          // ✅ NAVIGASI ke LocationDetailPage dengan data lokasi
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => LocationDetailPage(lokasi: item),
                            ),
                          );
                        },
                      ),
  ...
  Widget _buildImagePlaceholder() {
    return Container(
      ...
      child: const Center(child: Icon(Icons.mosque_outlined, size: 56, color: Colors.white24)),
    );
  }

  Widget _buildButton({required String label, required IconData icon, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
